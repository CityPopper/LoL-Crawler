...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        # -- System page --
        "page_system": "System",
        "system_section_streams": "Streams",
        "system_section_ratelimiter": "Rate Limiter",
        "system_section_metrics": "Request Metrics",
        "system_col_source": "Source",
        "system_col_short": "Short (1s)",
        "system_col_long": "Long (2min)",
        "system_col_cooling": "Cooling off",
        "system_col_last1m": "Last 1m",
        "system_col_last10m": "Last 10m",
        "system_col_last30m": "Last 30m",
        "system_col_avg_rpm": "Avg req/min",
        "system_cooling_yes": "\u26a0 yes",
        "system_cooling_no": "\u2014",
        # -- Consumer group name labels --
        "group_crawlers": "crawlers",
        "group_fetchers": "fetchers",
        "group_parsers": "parsers",
        "group_analyzers": "analyzers",
        "group_recovery": "recovery",
        "group_discovery": "discovery",
        "group_delay_scheduler": "delay_scheduler",
        # -- Stream key labels --
        "stream_key_stream:puuid": "stream:puuid",
        "stream_key_stream:match_id": "stream:match_id",
        "stream_key_stream:parse": "stream:parse",
        "stream_key_stream:analyze": "stream:analyze",
        "stream_key_stream:dlq": "stream:dlq",
        "stream_key_stream:dlq:archive": "stream:dlq:archive",
        "stream_key_delayed:messages": "delayed:messages",
        # -- Champions page --
    ...
    "zh-CN": {
        ...
        # -- System page --
        "page_system": "系统",
        "system_section_streams": "流",
        "system_section_ratelimiter": "速率限制",
        "system_section_metrics": "请求指标",
        "system_col_source": "来源",
        "system_col_short": "短窗口",
        "system_col_long": "长窗口",
        "system_col_cooling": "冷却中",
        "system_col_last1m": "1分钟",
        "system_col_last10m": "10分钟",
        "system_col_last30m": "30分钟",
        "system_col_avg_rpm": "平均请求/分",
        "system_cooling_yes": "\u26a0 是",
        "system_cooling_no": "\u2014",
        # -- Consumer group name labels --
        "group_crawlers": "爬虫",
        "group_fetchers": "获取器",
        ...
        "group_analyzers": "分析器",
        "group_recovery": "恢复服务",
        "group_discovery": "发现服务",
        "group_delay_scheduler": "延迟调度器",
        # -- Stream key labels --
        "stream_key_stream:puuid": "玩家ID流",
        "stream_key_stream:match_id": "对局ID流",
        "stream_key_stream:parse": "解析任务流",
        "stream_key_stream:analyze": "分析任务流",
        "stream_key_stream:dlq": "死信队列流",
        "stream_key_stream:dlq:archive": "死信归档流",
        "stream_key_delayed:messages": "延迟消息",
        # -- Champions page --
